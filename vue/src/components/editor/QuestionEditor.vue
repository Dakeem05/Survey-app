...
import {v4 as uuidv4 } from "uuid";
    ...
    // console.log(upperCaseFirst(questionTypes))
...
<template>
    ...
    <div class="grid gap-3 grid-cols-12">
        <div class="mt-3 col-span-9">
            ...
            <input type="text" :name="'question_text_' + model.data" :id="'question_text_' + model.data" v-model="model.question" @change="dataChange" class="focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
        </div>

        <div class="mt-3 col-span-3">
            <label for="question_type" class="block text-sm font-medium text-gray-700">Select Question Type</label>
            <select name="question_type" @change=typeChange id="question_type" class="mt-1
          block
          w-full
          py-2
          px-3
