...
<template>
    <div  class="flex flex-col py-4 px 6 shadow-md bg-white hover:bg-gray-50:h-[470px]">
      <img :src="survey.image_url" :alt="survey.title" class="w-full h-48 object-contain">
      ...
      <div class="flex justify-between items-center mt-3">
        ...
        <button type="button" @click="emit('delete', survey)" class="h-8 w-8 flex items-center justify-center rounded-full border border-transparent text-sm text-red-500 focus:ring-2 focus:ring-offdet-2 focus:ring-red-500">
