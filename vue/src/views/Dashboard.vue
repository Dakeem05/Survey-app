<template>
    <PageComponent title="Dashboard">
        <div v-if="loading" role="status" class="flex absolute right-1/2 top-1/2 mx-auto my-auto place-content-center">
          <span>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 text-gray-700" v-else>
            <div class="bg-white shadow-md p-3 text-center animate-fade-in-down flex flex-col order-1 lg:order-2" style="animation-delay: 0.1s;">
                <h3 class="text-2xl font-semibold">Total Surveys</h3>
                <div class="text-8xl font-semibold flex-1 flex items-center justify-center">
                    {{ data.totalSurveys }}
                </div>
            </div>
            <div class="bg-white shadow-md p-3 text-center animate-fade-in-down flex flex-col order-2 lg:order-4" style="animation-delay: 0.2s;">
                <h3 class="text-2xl font-semibold">Total Answers</h3>
                <div class="text-8xl font-semibold flex-1 flex items-center justify-center">
                    {{ data.totalAnswers }}
                </div>
            </div>
            <div class="bg-white shadow-md p-4 row-span-2 animate-fade-in-down order-3 lg:order-1">
                <h3 class="text-2xl font-semibold">Total Answers</h3>
            ...
            <div class="bg-white shadow-md p-3 row-span-2 animate-fade-in-down order-4 lg:order-3" style="animation-delay: 0.3s;">
                <div class="flex justify-between items-center mb-3 px-2">
                    <h3 class="text-2xl mb-3 font-semibold">Latest answers</h3>
                    <a href="javascript:void(0)" class="text-sm text-blue hover:decoration-blue-500"></a>
                </div>
                    <a href="#" v-for="answers of data.latestAnswers" :key="answers.id" class="block p-2 hover:bg-gray-100/90">
